...
export default function EditProperty() {
  ...
  useEffect(() => {
    if (!form || !leafletReady || !window.L) return;
    ...
    let map;
    try {
      const container = document.getElementById('edit-property-map');
      if (!container || container._leaflet_id) return;

      map = window.L.map('edit-property-map').setView([coords.lat, coords.lng], 13);
      ...
      console.warn('EditProperty map error:', err);
    }
    ...
    return (
      <div className="min-h-screen bg-[#FCFCFC]">
        ...
        <div className="flex flex-col items-center justify-center py-32 space-y-4">
          ...
          <p className="text-gray-400 font-semibold text-sm">Loading stay detail...</p>
        </div>
      </div>
    );
  }
      ...
      <main className="max-w-2xl mx-auto px-4 py-8 space-y-6 animate-fade-in">
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 tracking-tight flex items-center gap-2">
            <Edit2 className="w-7 h-7 text-[#FF385C]" /> Edit Listing
          </h1>
          <p className="text-xs sm:text-sm text-gray-500 mt-1">Make changes to your published stay listing</p>
        </div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Describe your nesting place..."
                rows={4}
                className="w-full border border-gray-250 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-[#FF385C]"
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div id="edit-property-map" className="w-full h-64 bg-gray-100 rounded-2xl border border-gray-150 relative"></div>
